    ...
    <section id="skills" className="py-10 px-4 max-w-7xl mx-auto bg-custom-pink border-2 border-b-4 border-r-4 border-black rounded-3xl shadow-neo">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <SkillCategory 
            ...
            skills={['React.js', 'HTML5', 'CSS3', 'Tailwind CSS', 'Vite', 'Responsive Design', 'NextJS']} 
        />
        <SkillCategory 
            title="Backend" 
            color="bg-custom-green"
            skills={['Node.js', 'Express.js', 'REST APIs', 'JWT Auth', 'Fast API', 'Django']} 
        />
        <SkillCategory 
            title="Databases" 
        ...
        <SkillCategory 
            title="Core CS" 
            color="bg-custom-red"
            skills={['DSA', 'OOP', 'OS', 'Computer Networks', 'Distributed Systems' ,'System Design']} 
        />
        <SkillCategory 
            title="Tools & Cloud" 
            color="bg-purple-300"
