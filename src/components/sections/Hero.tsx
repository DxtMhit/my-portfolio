  ...
  return (
    <section className="pt-4 pb-10 px-4 max-w-7xl mx-auto flex flex-col md:flex-row gap-8 items-start justify-center">
      ...
      <div className="w-full md:w-1/3 bg-white border-4 border-black rounded-3xl p-6 shadow-neo flex flex-col items-center text-center relative overflow-hidden">
        ...
        <h1 className="text-4xl font-shrikhand mb-1">MOHIT</h1>
        ...
        <div className="flex gap-4 mt-6 text-2xl">
          <a href="https://github.com/DxtMhit" target="_blank" className="hover:scale-110 transition-transform"><FaGithub /></a>
          <a href="https://www.linkedin.com/in/dxtmhit/" target="_blank" className="hover:scale-110 transition-transform text-blue-700"><FaLinkedin /></a>
          <a href="https://leetcode.com/u/mohitdixit/" target="_blank" className="hover:scale-110 transition-transform text-orange-600"><FaCode /></a>
        </div>
      </div>
      ...
      <div className="w-full md:w-2/3 flex flex-col gap-6" id="about">
        ...
        <div className="bg-custom-yellow p-6 md:p-10 rounded-3xl border-4 border-black shadow-neo">
          ...
          <p className="text-lg font-medium leading-relaxed mb-4">
            I am a <span className="font-bold bg-white px-1 border border-black">4th-year (final) student at ITM Baroda</span>, pursuing a Bachelor of Technology in Computer Science and Engineering. I define myself as a <span className="font-bold bg-white px-1 border border-black">strong hard working Man</span> aspiring to build scalable software.
          </p>
          <p className="text-lg font-medium leading-relaxed mb-4">
          ...
          <div className="bg-white p-4 border-2 border-black rounded-xl inline-block font-bold shadow-neo-sm ">
            🚀 Open to Software and AI/ML Engineer roles
          </div>
        </div>
